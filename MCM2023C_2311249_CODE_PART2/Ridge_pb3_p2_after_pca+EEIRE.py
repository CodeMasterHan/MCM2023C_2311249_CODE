...
y_predict.index = class_result.index
class_result = pd.concat([class_result, y_predict], join="outer", axis=1)
class_result.columns = ['index','word','score_true','class_true','score_perdict','class_predict']
...
EERIE_diffi_score = model.predict(EERIE_x)
EERIE_diffi_level = -1
if EERIE_diffi_score < boundry_0_1:
    EERIE_diffi_level = 0
elif EERIE_diffi_score < boundry_1_2:
    EERIE_diffi_level = 1
elif EERIE_diffi_score < boundry_2_3:
    EERIE_diffi_level = 2
else:
    EERIE_diffi_level = 3
    
print(EERIE_diffi_level)
